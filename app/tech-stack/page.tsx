...
export default function TechStackPage() {
  return (
    <>
      <div className="flex justify-center text-center mx-auto mt-5 w-2xl">
        <InfoIcon className="text-red-600 w-10 h-10"></InfoIcon>
        <span>
          This is a <span className="font-bold">side project </span>built for learning purposes. While the
          core features work well, some areas are still being refined. Thanks
          for your patience - improvements are ongoing!
        </span>
      </div>
